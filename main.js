...
app.post('/addcontact', function(req, res) { 
	...
	// Check if correct format
	if((checkInput(req.body.firstname, "name") || req.body.firstname === "") && (checkInput(req.body.lastname, "name") || req.body.lastname === "") && (checkInput(req.body.phone, "phone") || req.body.phone === "") && (checkInput(req.body.email, "email") || req.body.email === "")) {
